...
13. **Power of Three** – [LeetCode #326](https://leetcode.com/problems/power-of-three/)
14. **Factorial** – [LeetCode #69](https://leetcode.com/problems/factorial/)
15. **Unique Binary Search Trees** – [LeetCode #96](https://leetcode.com/problems/unique-binary-search-trees/)
16. **Unique Binary Search Trees II** – [LeetCode #95](https://leetcode.com/problems/unique-binary-search-trees-ii/)
17. **Reverse Linked List** – [LeetCode #206](https://leetcode.com/problems/reverse-linked-list/)
18. **Letter Combinations of a Phone Number** – [LeetCode #17](https://leetcode.com/problems/letter-combinations-of-a-phone-number/)
19. **Maximum Depth of Binary Tree** – [LeetCode #104](https://leetcode.com/problems/maximum-depth-of-binary-tree/)
20. **Path Sum** – [LeetCode #112](https://leetcode.com/problems/path-sum/)
21. **Binary Tree Inorder Traversal** – [LeetCode #94](https://leetcode.com/problems/binary-tree-inorder-traversal/)
22. **Binary Tree Preorder Traversal** – [LeetCode #144](https://leetcode.com/problems/binary-tree-preorder-traversal/)
23. **Binary Tree Postorder Traversal** – [LeetCode #145](https://leetcode.com/problems/binary-tree-postorder-traversal/)
24. **Subset Sum** – [LeetCode #78](https://leetcode.com/problems/subsets/)
25. **Fibonacci Number** – [LeetCode #509](https://leetcode.com/problems/fibonacci-number/)
26. **Combinations** – [LeetCode #77](https://leetcode.com/problems/combinations/)
27. **Decode Ways** – [LeetCode #91](https://leetcode.com/problems/decode-ways/)
28. **Target Sum** – [LeetCode #494](https://leetcode.com/problems/target-sum/)
29. **Letter Combinations of a Phone Number** – [LeetCode #17](https://leetcode.com/problems/letter-combinations-of-a-phone-number/)
30. **Subset Sum II** – [LeetCode #90](https://leetcode.com/problems/subsets-ii/)
31. **Jump Game II** – [LeetCode #45](https://leetcode.com/problems/jump-game-ii/)
32. **Coin Change** – [LeetCode #322](https://leetcode.com/problems/coin-change/)
33. **Binary Search** – [LeetCode #704](https://leetcode.com/problems/binary-search/)
34. **Balanced Binary Tree** – [LeetCode #110](https://leetcode.com/problems/balanced-binary-tree/)
35. **All Paths from Source to Target** – [LeetCode #797](https://leetcode.com/problems/all-paths-from-source-to-target/)
36. **Path Sum II** – [LeetCode #113](https://leetcode.com/problems/path-sum-ii/)
37. **Generate Parentheses** – [LeetCode #22](https://leetcode.com/problems/generate-parentheses/)
38. **Find Minimum in Rotated Sorted Array** – [LeetCode #153](https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/)
39. **Power of Four** – [LeetCode #342](https://leetcode.com/problems/power-of-four/)
40. **Balanced Binary Tree** – [LeetCode #110](https://leetcode.com/problems/balanced-binary-tree/)
41. **Combination Sum IV** – [LeetCode #377](https://leetcode.com/problems/combination-sum-iv/)
42. **Strobogrammatic Number II** – [LeetCode #247](https://leetcode.com/problems/strobogrammatic-number-ii/)
43. **Reverse Integer** – [LeetCode #7](https://leetcode.com/problems/reverse-integer/)
44. **String Permutations** – [LeetCode #47](https://leetcode.com/problems/permutations-ii/)
45. **Letter Combinations of a Phone Number** – [LeetCode #17](https://leetcode.com/problems/letter-combinations-of-a-phone-number/)
46. **All Unique Permutations** – [LeetCode #46](https://leetcode.com/problems/permutations/)
47. **Minimum Path Sum** – [LeetCode #64](https://leetcode.com/problems/minimum-path-sum/)
48. **Pascal's Triangle II** – [LeetCode #119](https://leetcode.com/problems/pascals-triangle-ii/)
49. **House Robber** – [LeetCode #198](https://leetcode.com/problems/house-robber/)
50. **House Robber II** – [LeetCode #213](https://leetcode.com/problems/house-robber-ii/)
...
3. **House Robber II** – [LeetCode #213](https://leetcode.com/problems/house-robber-ii/)
4. **Longest Increasing Subsequence** – [LeetCode #300](https://leetcode.com/problems/longest-increasing-subsequence/)
5. **Coin Change** – [LeetCode #322](https://leetcode.com/problems/coin-change/)
6. **Edit Distance** – [LeetCode #72](https://leetcode.com/problems/edit-distance/)
7. **Word Break** – [LeetCode #139](https://leetcode.com/problems/word-break/)
8. **Word Break II** – [LeetCode #140](https://leetcode.com/problems/word-break-ii/)
9. **Longest Common Subsequence** – [LeetCode #1143](https://leetcode.com/problems/longest-common-subsequence/)
10. **Partition Equal Subset Sum** – [LeetCode #416](https://leetcode.com/problems/partition-equal-subset-sum/)
11. **Combination Sum IV** – [LeetCode #377](https://leetcode.com/problems/combination-sum-iv/)
12. **Maximum Product Subarray** – [LeetCode #152](https://leetcode.com/problems/maximum-product-subarray/)
13. **Unique Paths** – [LeetCode #62](https://leetcode.com/problems/unique-paths/)
14. **Unique Paths II** – [LeetCode #63](https://leetcode.com/problems/unique-paths-ii/)
15. **Jump Game** – [LeetCode #55](https://leetcode.com/problems/jump-game/)
16. **Jump Game II** – [LeetCode #45](https://leetcode.com/problems/jump-game-ii/)
17. **Decode Ways** – [LeetCode #91](https://leetcode.com/problems/decode-ways/)
18. **Best Time to Buy and Sell Stock** – [LeetCode #121](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/)
19. **Best Time to Buy and Sell Stock II** – [LeetCode #122](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-ii/)
20. **Best Time to Buy and Sell Stock III** – [LeetCode #123](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-iii/)
21. **Best Time to Buy and Sell Stock IV** – [LeetCode #188](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-iv/)
22. **Maximum Subarray** – [LeetCode #53](https://leetcode.com/problems/maximum-subarray/)
23. **Minimum Path Sum** – [LeetCode #64](https://leetcode.com/problems/minimum-path-sum/)
24. **KnapSack Problem** – [LeetCode #416](https://leetcode.com/problems/partition-equal-subset-sum/)
25. **Longest Palindromic Substring** – [LeetCode #5](https://leetcode.com/problems/longest-palindromic-substring/)
26. **Longest Palindromic Subsequence** – [LeetCode #516](https://leetcode.com/problems/longest-palindromic-subsequence/)
27. **Integer Break** – [LeetCode #343](https://leetcode.com/problems/integer-break/)
28. **Integer Partition** – [LeetCode #64](https://leetcode.com/problems/minimum-path-sum/)
29. **Rod Cutting** – [LeetCode #214](https://leetcode.com/problems/longest-palindromic-subsequence/)
30. **Coin Change II** – [LeetCode #518](https://leetcode.com/problems/coin-change-ii/)
31. **Palindrome Partitioning II** – [LeetCode #132](https://leetcode.com/problems/palindrome-partitioning-ii/)
32. **Minimum Cost Climbing Stairs** – [LeetCode #746](https://leetcode.com/problems/min-cost-climbing-stairs/)
33. **House Robber III** – [LeetCode #337](https://leetcode.com/problems/house-robber-iii/)
34. **Fibonacci Number** – [LeetCode #509](https://leetcode.com/problems/fibonacci-number/)
35. **Longest Common Substring** – [LeetCode #718](https://leetcode.com/problems/maximum-length-of-repeated-subarray/)
36. **Maximum Length of Repeated Subarray** – [LeetCode #718](https://leetcode.com/problems/maximum-length-of-repeated-subarray/)
37. **Minimum Window Substring** – [LeetCode #76](https://leetcode.com/problems/minimum-window-substring/)
38. **Substring with Concatenation of All Words** – [LeetCode #30](https://leetcode.com/problems/substring-with-concatenation-of-all-words/)
39. **Integer Partition** – [LeetCode #214](https://leetcode.com/problems/longest-palindromic-subsequence/)
40. **Target Sum** – [LeetCode #494](https://leetcode.com/problems/target-sum/)
41. **Number of Longest Increasing Subsequence** – [LeetCode #673](https://leetcode.com/problems/number-of-longest-increasing-subsequence/)
42. **Word Search II** – [LeetCode #212](https://leetcode.com/problems/word-search-ii/)
43. **Maximal Square** – [LeetCode #221](https://leetcode.com/problems/maximal-square/)
44. **Minimum Deletions to Make Character Frequencies Unique** – [LeetCode #1648](https://leetcode.com/problems/minimum-deletions-to-make-character-frequencies-unique/)
45. **Unique Paths III** – [LeetCode #980](https://leetcode.com/problems/unique-paths-iii/)
46. **Edit Distance** – [LeetCode #72](https://leetcode.com/problems/edit-distance/)
47. **Scramble String** – [LeetCode #87](https://leetcode.com/problems/scramble-string/)
48. **Find the Minimum Cost to Reach the End** – [LeetCode #135](https://leetcode.com/problems/minimum-cost-for-tickets/)
49. **Longest Increasing Path in a Matrix** – [LeetCode #329](https://leetcode.com/problems/longest-increasing-path-in-a-matrix/)
50. **Decode String** – [LeetCode #394](https://leetcode.com/problems/decode-string/)

These problems focus on various dynamic programming approaches including:
- **Memoization and Tabulation:** (Top-down and Bottom-up approaches)
- **Optimization problems:** Like stock buy/sell, coin change, knapsack problem.
- **Subsequence problems:** Longest increasing subsequence, edit distance, and palindromes.
- **Path-related problems:** Like unique paths and path sum.
